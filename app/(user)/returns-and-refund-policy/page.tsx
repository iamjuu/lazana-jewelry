      ...
      <section className="w-full mt-[25px]">
        <div className="max-w-6xl mx-auto px-4">
          ...
          <div className="font-seasons">
            <h2 className="text-[#D5B584] text-[28px] sm:text-[32px] md:text-[30px] lg:text-[32px] font-normal ">
          ...
          <div className="flex flex-col gap-[1px]">
            ...
            <div className="mt-[25px]">
              ...
              <div className=" text-[#5A5A5A] text-[14px] sm:text-[16px] md:text-[14px] font-light leading-relaxed font-touvlo">
                ...
                <p>
                  In some circumstances, we may be able to offer modifications
                  (such as changing the tuning system or note). However, this
                  cannot be guaranteed once production has begun.
                </p>
                <p>
