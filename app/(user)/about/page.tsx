      ...
      <div className="max-w-7xl border-b border-[#D5B584] mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid pt-[30px] sm:pt-[40px] md:pt-[54px] grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-start pb-[40px]">
          ...
          <div className="w-full">
            ...
            {/* <div className="flex mt-5 flex-col text-[16px] sm:text-[18px] md:text-[20px] lg:text-[22px] gap-[20px] sm:gap-[25px] md:gap-[30px]">
              <p>
              ...
              <h1 className="text-[20px] sm:text-[24px]  md:text-[20px] lg:text-[26px] text-black font-[400]">
