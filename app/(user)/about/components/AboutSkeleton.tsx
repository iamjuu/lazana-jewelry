const AboutSkeleton = () => {
  return (
    <div className="bg-white min-h-screen">
      ...
      <div className="max-w-7xl border-b border-[#000000]/30 mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid pt-[30px] sm:pt-[40px] md:pt-[54px] grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-4">
          {[1, 2, 3].map((item) => (
            <div key={item} className="relative overflow-hidden">
              ...
              <div className="w-full aspect-square bg-gradient-to-r from-[#000000]/20 via-[#000000]/40 to-[#000000]/20 relative overflow-hidden">
        ...
        <div className="w-full py-[40px]">
          <div className="md:w-[70%] w-full">
            ...
            <div className="mb-[20px] sm:mb-[25px] md:mb-[30px]">
              <div className="h-[18px] sm:h-[22px] md:h-[30px] bg-[#000000]/30 rounded w-[200px] mb-2 relative overflow-hidden">
                <div className="absolute inset-0 animate-shimmer bg-gradient-to-r from-transparent via-white/40 to-transparent" />
              </div>
            ...
            <div className="flex flex-col text-[14px] sm:text-[15px] md:text-[16px] font-[300] gap-[20px] sm:gap-[25px] md:gap-[30px]">
              ...
              <div className="h-[20px] sm:h-[24px] md:h-[28px] lg:h-[30px] bg-[#000000]/30 rounded w-[90%] relative overflow-hidden">
                <div className="absolute inset-0 animate-shimmer bg-gradient-to-r from-transparent via-white/40 to-transparent" />
              </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-[60px] sm:py-[80px] md:py-[100px]">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
          ...
          <div className="space-y-6">
            ...
            <div className="h-[32px] sm:h-[40px] md:h-[48px] bg-[#000000]/30 rounded w-[250px] relative overflow-hidden">
              <div className="absolute inset-0 animate-shimmer bg-gradient-to-r from-transparent via-white/40 to-transparent" />
            </div>
          ...
          <div className="relative w-full flex justify-center lg:justify-end py-8 sm:py-12 md:py-16">
            <div className="relative w-full max-w-[240px] sm:max-w-[280px] md:max-w-[300px]">
              ...
              <div className="relative w-full aspect-[3/4] rounded-[15px] sm:rounded-[18px] md:rounded-[20px] overflow-hidden shadow-2xl z-10 bg-gradient-to-br from-[#000000]/30 via-[#000000]/20 to-[#000000]/30">
                <div className="absolute inset-0 animate-shimmer bg-gradient-to-r from-transparent via-white/40 to-transparent" />
              </div>
            </div>
          </div>
