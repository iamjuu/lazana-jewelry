...
// DELETE - Delete a product coupon
export async function DELETE(
  ...
  try {
    ...
    const coupon = await ProductCoupon.findByIdAndDelete(id);
...
export async function PATCH(
  ...
  try {
    ...
    if (excludedCategories !== undefined) {
      updateData.excludedCategories = excludedCategories;
    }
    ...
    const coupon = await ProductCoupon.findByIdAndUpdate(
      id,
      { $set: updateData },
      { new: true }
    )
    ...
    console.error("Update product coupon error:", e);
